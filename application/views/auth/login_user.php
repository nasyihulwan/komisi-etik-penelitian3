                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-6 ms-auto text-end">
                          <a href="<?= base_url('auth/user_registration') ?>" class="btn btn-sm btn-outline-danger">Don't have an account? User Registration here</a>
                        </div> 
                      </div>                    
                      ...
                      <form action="<?= base_url('auth') ?>" method="POST" class="needs-validation">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control <?= $this->session->userdata('email_invalid')||form_error('email') ? 'is-invalid' : ''; ?>" id="email" name="email" value="<?= set_value('email'); ?>">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password" class="form-control <?= $this->session->userdata('password_invalid')||form_error('password') ? 'is-invalid' : ''; ?>" id="password" name="password" value="<?= set_value('password'); ?>">
                        ...
                        <div class="text-center">
                          <button type="submit" class="btn btn-danger"><i class="bi bi-arrow-return-right"></i> Login</button>
                        </div>
                      </form>
                    </div>
                </div>
