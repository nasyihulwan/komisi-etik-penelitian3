   ...
   <footer id="footer">
               ...
               <div class="row">
                   ...
                   <div class="col-lg-6 col-md-6">
                       <div class="footer-info">
                           <div class="row">
                               <div class="col-12 col-md-4 mb-5 mb-md-0" data-aos="fade-right">
                                   <img src="<?= base_url() ?>assets/img/UPI-Logo-white.png" class="img-fluid" alt="">
                               </div>
                               <div class="col-12 col-md-8" data-aos="fade-up">
                                   <h3>Komisi Etik Penelitian</h3>
                                   <p class="pb-3"><em>Universitas Pendidikan Indonesia</em></p>
                                   <p>
                                       Jalan Dr. Setiabudhi No. 229 Bandung 40154 <br>
                                       Jawa Barat, Indonesia<br><br>
                                       <strong>Phone:</strong> +628522462685<br>
                                       <strong>Fax:</strong> 022-2013651<br>
                                       <strong>Email:</strong> etikpenelitian@upi.edu<br>
                                   </p>
       ...
       <div class="container">
           <div class="copyright">
               &copy; Copyright 2023 <strong><span>Komisi Etik Penelitian</span></strong> Universitas Pendidikan
